    ...
    <div className="space-y-8">
      ...
      <div>
        <div className="flex items-center gap-2 mb-5">
          ...
          <span className="px-4 py-1.5 bg-gray-800 text-white text-sm font-bold rounded-full">
            현재 운영 방식
          </span>
          <div className="h-px flex-1 bg-gray-300"></div>
        </div>
            ...
            <div className="bg-gray-50 rounded-lg p-4">
              ...
              <div className="grid grid-cols-3 gap-2 text-center">
                <div className="bg-white rounded-lg p-3 border border-gray-200">
                  ...
                  <p className="text-lg font-bold text-gray-800">3만원</p>
                </div>
            ...
            <div className="bg-white rounded-lg p-4 space-y-4">
              ...
              <div className="relative">
                ...
                <div className="relative flex items-start gap-4">
                  ...
                  <div className="bg-orange-100 rounded-lg p-3 flex-1 border border-orange-300">
        ...
        <section>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            <div className="bg-green-50 border border-green-200 rounded-lg p-4">
              ...
              <p className="text-2xl font-bold text-green-700">약 240만원</p>
              <p className="text-xs text-gray-500 mt-1">
                4월 MT 비용 제외 기준
              </p>
            </div>
            <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
              ...
              <p className="text-2xl font-bold text-blue-700">약 20만원</p>
              <p className="text-xs text-gray-500 mt-1">
                회원 10인 체제 기준
              </p>
            </div>
      ...
      <div>
        <div className="flex items-center gap-2 mb-5">
          ...
          <span className="px-4 py-1.5 bg-indigo-600 text-white text-sm font-bold rounded-full">
            ...
            <div className="grid grid-cols-2 divide-x divide-gray-200">
              <div className="p-5 text-center">
                ...
                <p className="text-2xl font-bold text-gray-800">
                  5~6만원<span className="text-sm font-normal text-gray-500">/월</span>
                </p>
              ...
              <div className="p-5 text-center bg-indigo-50">
                ...
                <p className="text-2xl font-bold text-indigo-700">
                  5.5만원<span className="text-sm font-normal text-indigo-400">/월</span>
                </p>
